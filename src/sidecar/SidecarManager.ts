	...
	async start(): Promise<void> {
		...
		this.process = cp.spawn('node', [sidecarUri.fsPath], {
			...
			env: {
				...
				NEUROCODE_LLM_MODE: cfg.llm.mode,
				NEUROCODE_LLM_API_URL: cfg.llm.apiBaseUrl,
				NEUROCODE_LLM_API_KEY: cfg.llm.apiKey,
				NEUROCODE_LLM_MODEL: cfg.llm.model,
				NEUROCODE_LLM_GATEWAY_LABEL: cfg.llm.gatewayLabel,
				...
				NEUROCODE_MAX_FILES: String(cfg.shard.maxFiles),
			},
